...
export function NavSearch() {
  ...
  return (
    <button
      ...
      className="flex flex-col items-center gap-[3px] text-[10.5px] font-medium p-1 transition-colors duration-150 text-ink-3 hover:text-ink-2 focus:outline-none cursor-pointer"
    >
